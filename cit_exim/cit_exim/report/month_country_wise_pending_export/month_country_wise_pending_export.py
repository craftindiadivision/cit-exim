...
#             # COUNTRY
#             country_key = f"{month}::{country}"

#             if country_key not in month_map:
#                 month_map[country_key] = {
#                     "month_country": country,
#                     "parent": month,
#                     "sort_key": sort_key
#                 }

#             month_map[country_key][column_name] = month_map[country_key].get(column_name, 0) + pending_qty
...
#         countries.sort(key=lambda x: x.get("month_country"))
