...
//             frappe.call({
//                 method: "cit_exim.cit_exim.doc_events.sales_invoice.get_consignee_default_address",
//                 args: {
...
frappe.ui.form.on('Sales Invoice', {
    custom_map_address: function(frm) {
        ...
        frappe.call({
            method: 'cit_exim.cit_exim.doc_events.sales_invoice.map_buyer_to_consignee_address',
            args: {
                buyer: buyer,
                consignee: consignee
            },
            callback: function(r) {
                if (r.message) {
                    ...
                    // ✅ Force Billing Address from Buyer
