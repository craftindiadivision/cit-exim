...
fixtures=[
    ...
    "filters": [
        ["name", "in", [
           ...
           "Sales Invoice-sales_team_section_break-depends_on","Sales Invoice-section_break_49-depends_on","Sales Invoice-loyalty_points_redemption-depends_on","Sales Invoice-time_sheet_list-depends_on","Sales Invoice-mode_of_transport-Options"
